      				...
      				<tr>
        				<td><?php echo $text_availability; ?></td>
      					...
      					<tr>
        					...
        					<?php foreach ($products as $product) { ?>
        						<td>
									<img src="catalog/view/theme/default/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
   						...
   						<?php foreach ($products as $product) { ?>
   							<td>
								<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
       								...
       								<a class="button" onclick="$(this).parent().submit();">Remove</a>
       							</form>
							</td>
   						<?php } ?>
   					</tr>
				</table>
						<a href="<?php echo $continue; ?>" class="button button-full"><?php echo $button_continue; ?></a>
		<?php } else { ?>
